 ...
 * to add those. Additionaly you can set the program version with {@link setVersion()}, the summary with
 * {@link setSummary()} and the footer with {@link setFooter()}.
 *
 * @author  Jan Oetjen <jo@onscreen.net>
 * @version 0.0.1
 */
